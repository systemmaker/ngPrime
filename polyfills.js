...
(function (global, factory) {
  ...
  Zone.__load_patch('ZoneAwarePromise', function (global, Zone, api) {
    ...
    function patchThen(Ctor) {
      ...
      proto[symbolThen] = originalThen; // check Ctor.prototype.then propertyDescriptor is writable or not
      // in meteor env, writable is false, we have to make it to be true.

      var prop = ObjectGetOwnPropertyDescriptor(Ctor.prototype, 'then');

      if (prop && prop.writable === false && prop.configurable) {
        ObjectDefineProperty(Ctor.prototype, 'then', {
          writable: true
        });
      }
...
__webpack_require__(/*! D:\primeng\src\polyfills.ts */"hN/g");
module.exports = __webpack_require__(/*! D:\primeng\node_modules\@angular-devkit\build-angular\src\angular-cli-files\models\jit-polyfills.js */"LEsg");
